...
<div class="smallbox" style="display: flex; justify-content: center;">
    ...
    <br><br>
    <form action="./commentedit2" method="post" onsubmit="return formCheck(this)">
    <input type="hidden" name="star" id="starValue" value="${c.star }">
        <div id="form" style="margin-left:30px;" >
            ...
            <div class="down" style="margin-top: 20px;">
                <div class="stars" onclick="rateStars(event)" style="text-align:center;">
                	<c:forEach begin="1" end="${c.star }" var="i">
	                    <img src="/FinalProject0430/img/음식사진/노란별.png" alt="별1" id="star${i }">
                	</c:forEach>
                	<c:forEach begin="1" end="${ 5-c.star}">                	
                  	  <img src="/FinalProject0430/img/음식사진/투명별.png" alt="별1" >
                	</c:forEach>
            ...
            <br>
            <textarea id="content" name="comment" rows="20" cols="100" style="border: 3px solid black;border-radius: 30px; width: 100%; margin-left: 20px;padding:10px;">${c.comment}</textarea>
            <input class="log"type="hidden" id="starValue" name="starVar">
            <input class="log" type="hidden" name="cno" value="${param.cno }">
            <input class="log" type="hidden" name="bno" value="${param.bno }">
            <br>
            <br>
            <input class="log"type="submit" value="수정완료" style="margin-left:700px;">
